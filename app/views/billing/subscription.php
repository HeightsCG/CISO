...
<div class="page">
    ...
    <div class="page__head">
        ...
        <div class="page__actions">
            ...
            <button type="button" class="btn btn--primary" id="do_activate_open"><i class="fa-regular fa-play"></i> Start Retainer</button>
            <?php } ?>
            <?php if ($is_live && !$ending) { ?>
            <button type="button" class="btn btn--destructive" id="do_cancel_open"><i class="fa-regular fa-ban"></i> Cancel Retainer</button>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="alert alert--warn" role="status">
        ...
        <p class="alert__title">The last attempt to start this retainer did not go through</p>
    ...
    <div class="alert alert--critical" role="status">
        <i class="fa-regular fa-triangle-exclamation alert__icon" aria-hidden="true"></i>
        <p class="alert__title">This retainer is still being started</p>
    ...
    <div class="alert alert--warn" role="status">
        <i class="fa-regular fa-triangle-exclamation alert__icon" aria-hidden="true"></i>
        <p class="alert__title">This retainer ends on <?php echo htmlspecialchars($this->subscription['renews_display'], ENT_QUOTES, 'UTF-8'); ?></p>
        <p class="alert__text">The client is not billed again after that date. Invoices already raised are unaffected.</p>
    </div>
    <?php } ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="activate_modal_title">Start Retainer</h2>
            ...
            <div class="modal-body">
                ...
                <p class="import__hint">An invoice is raised and emailed to the client every period until the retainer is cancelled. The amount cannot be changed afterwards.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn--secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" id="do_activate" class="btn btn--primary">Start Retainer</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" data-bs-backdrop="static" id="cancel_modal" tabindex="-1" aria-labelledby="cancel_modal_title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="cancel_modal_title">Cancel Retainer</h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Stop billing this client on this retainer?</p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn--secondary" data-bs-dismiss="modal">Keep retainer</button>
                <button type="button" id="do_cancel" class="btn btn--destructive">Cancel Retainer</button>
            </div>
        </div>
    </div>
</div>
