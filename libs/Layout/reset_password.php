...
$(document).ready(function () {
    ...
    $("#reset_view").prop("hidden") || $("#pw1").focus();
...
<div class="auth__module">
    ...
    <main class="auth__stage">
        ...
        <div class="auth__form" id="reset_view"<?php echo ($this->token_valid ? '' : ' hidden'); ?>>
            <h2 class="auth__heading">Create a New Password</h2>
            ...
            <div class="auth__actions">
                <a class="btn btn--tertiary" href="/">Back to Sign In</a>
            </div>
        </div>

        <div class="auth__form" id="expired_view"<?php echo ($this->token_valid ? ' hidden' : ''); ?>>
            <h2 class="auth__heading">This Link Is No Longer Valid</h2>
            <p class="auth__note">Reset links can only be used once and expire one hour after they are sent. Request a new one from the sign-in page and we will email you a fresh link.</p>
            <div class="auth__submit">
                <a class="btn btn--primary btn--block" href="/">Back to Sign In</a>
            </div>
        </div>
